...
pesan_join = os.environ.get("PESAN_JOIN", "Tidak Dapat Diakses Harap Join Channel Dan Grup Terlebih Dahulu")
start_msg = os.environ.get("START_MSG", "Hai {mention} 🌱\n\n<b>Alter FWB Bot</b> adalah Bot Auto Post, Semua Pesan Yang Kamu Kirim Akan Masuk Ke Channel @AlterFWB1 Secara Anonymous. Tekan /Help Untuk Bantuan.")

gagalkirim_msg = os.environ.get("GAGAL_KIRIM", """
{mention}, Pesan Mu Gagal Terkirim! Gunakan # Hashtag Berikut Saat Mengirim Promote Menggunakan Bot :
